package com.example.l_z0k.dadm_u4_practica1_gerardotovarbarragan;
...
import com.example.l_z0k.dadm_u4_practica1_gerardotovarbarragan.adapter.Datos;
import com.example.l_z0k.dadm_u4_practica1_gerardotovarbarragan.adapter.DiseaseAdapter;
...
public class MenuAlumno extends AppCompatActivity  implements AsyncResponse {
    ...
    String nombre2;
    String direccion2;
    //String url="127.0.0.1:8080";   //por ip local
    String url="dadm20117.000webhostapp.com";  // mediante servidor remoto
    ...
    private void fnInsertarDatos(final Integer ID, final Integer Operacion) {
        try {
            ...
            nombreT.setTextColor(Color.CYAN);
            domicilioT.setText("Domicilio:");
            domicilioT.setTextColor(Color.CYAN);
            ...
            if (!str.equals("{estado:2,mensaje:No se obtuvo el registro}") && !str.equals("{estado:1,mensaje:Creacion correcta}") && !str.equals("{estado:1,mensaje:Eliminacion exitosa}") && !str.equals("{estado:1,mensaje:Actualizacion correcta}")) {
                ...
                for (int j = 0; j < array.length; j++) {
                   String array2[]=array[j].split(",");
                            ...
                            datos.add(new Datos (array2[1].toString(), array2[2].toString(),Integer.parseInt(array2[0])));
